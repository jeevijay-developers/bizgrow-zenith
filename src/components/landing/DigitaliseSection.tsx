      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="bg-gradient-to-br from-primary/5 via-transparent to-accent/5 rounded-3xl p-6 md:p-10 border border-border">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            {/* CTA */}
            <Link to="/join">
              <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold px-8 py-6 rounded-xl shadow-lg shadow-primary/20 group whitespace-nowrap">
