      ...
      <div className="container mx-auto px-4 py-8 md:py-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-[calc(100vh-120px)]">
          ...
          <div className="text-center lg:text-left space-y-6 animate-slide-up">
            {/* Live Badge */}
            <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-md rounded-full px-5 py-2.5 border border-white/20 shadow-lg">
            ...
            {/* Headline */}
            <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white leading-[1.1] font-display">
              Your Shop,{" "}
            ...
            <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
              {[
                ...
                <div key={item.text} className="group flex items-center gap-2 bg-white/10 backdrop-blur-md rounded-full px-4 py-2 border border-white/15 hover:border-white/30 hover:bg-white/15 transition-all cursor-default">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
              <Link to="/join">
                <RippleButton size="xl" variant="glow-accent" className="font-bold w-full sm:w-auto group text-base">
                  Start Free — No Card Needed
                  <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
                </RippleButton>
              </Link>
              <RippleButton size="xl" variant="outline" className="border-white/25 text-white hover:bg-white/10 w-full sm:w-auto group">
              ...
              <div className="flex items-center gap-3">
                <div className="flex -space-x-3">
                  {["RS", "PP", "MI", "SD", "AK"].map((initials, i) => (
                    <div key={i} className="w-10 h-10 rounded-full bg-gradient-to-br from-accent to-amber-400 flex items-center justify-center text-xs font-bold text-primary border-3 border-primary shadow-lg" style={{ zIndex: 5 - i }}>
                      {initials}
                    </div>
                  ))}
                </div>
                <div className="text-left">
                  <div className="flex items-center gap-0.5">
                    ...
                    <span className="text-accent font-bold ml-1">4.9</span>
                  </div>
                  <span className="text-white/60 text-sm">1,000+ Happy Retailers</span>
                </div>
              </div>
              <div className="hidden sm:block w-px h-8 bg-white/20" />
              <div className="flex items-center gap-2">
                <CheckCircle className="w-5 h-5 text-green-400" />
                <span className="text-white/70 text-sm">Free Forever Plan Available</span>
              </div>
            </div>
          </div>

          {/* Right Content - Interactive Dashboard Preview */}
          <div className="relative flex justify-center items-center lg:scale-105">
            {/* Large glowing backdrop */}
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-[400px] h-[400px] md:w-[500px] md:h-[500px] bg-gradient-to-br from-accent/30 to-accent/10 rounded-full blur-3xl animate-pulse" />
            </div>
            ...
            <div className="absolute -top-2 -left-2 md:top-8 md:-left-4 float-animation z-20">
              <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-4 border border-gray-100/50 w-48 md:w-56 hover:scale-105 transition-transform cursor-pointer">
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-3 border border-green-100">
                  <p className="text-sm text-green-800 font-semibold">Priya Sharma</p>
                  <p className="text-xs text-green-600">3 items • ₹850 • Just now</p>
                </div>
              </div>
            </div>

            <div className="absolute top-1/4 -right-2 md:right-0 float-animation-delayed z-20">
              <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-4 border border-gray-100/50 w-44 md:w-52 hover:scale-105 transition-transform cursor-pointer">
                <div className="flex items-center gap-2 mb-3">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center shadow-lg">
                    <Sparkles className="w-5 h-5 text-white" />
                  </div>
                  <div>
                    <p className="font-bold text-gray-900 text-sm">AI Magic</p>
                    <p className="text-xs text-gray-500">Auto-detected</p>
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="h-2 bg-gradient-to-r from-amber-400 to-orange-500 rounded-full w-full animate-pulse" />
                  <div className="flex items-center gap-2">
                    <CheckCircle className="w-4 h-4 text-green-500" />
                    <p className="text-xs text-gray-700 font-medium">Parle-G Biscuit 250g</p>
                  </div>
                  <p className="text-xs text-gray-500">₹20 MRP • Biscuits Category</p>
                </div>
              </div>
            </div>

            <div className="absolute bottom-16 -left-2 md:left-4 float-animation z-20">
              <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-4 border border-gray-100/50 w-48 md:w-56 hover:scale-105 transition-transform cursor-pointer">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    <TrendingUp className="w-5 h-5 text-green-500" />
                    <p className="font-bold text-gray-900 text-sm">Today's Sales</p>
                  </div>
                  <span className="text-xs text-green-600 bg-green-100 px-2 py-1 rounded-full font-bold">+23%</span>
                </div>
                <p className="text-3xl font-bold text-gray-900 mb-2">₹12,450</p>
                <div className="flex items-center gap-2">
                  <div className="flex-1 h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-primary to-purple-600 rounded-full transition-all" style={{ width: "73%" }} />
                  </div>
                  <span className="text-xs text-gray-600 font-medium">73% of goal</span>
                </div>
              </div>
            </div>

            <div className="absolute bottom-4 right-4 md:right-12 float-animation-delayed z-20">
              <div className="bg-white/95 backdrop-blur-xl rounded-xl shadow-xl p-3 border border-gray-100/50 hover:scale-105 transition-transform cursor-pointer">
                <div className="flex items-center gap-3">
                  <div className="relative">
                    ...
                    <span className="absolute -top-1 -right-1 w-4 h-4 bg-red-500 rounded-full flex items-center justify-center text-[10px] text-white font-bold">3</span>
                  </div>
                  <div>
                    <span className="text-xs font-bold text-gray-800">Low Stock Alert</span>
                    <p className="text-[10px] text-gray-500">Maggi, Surf, Amul</p>
                  </div>
                </div>
              </div>
            </div>
