...
export const categoryConfigs: Record<string, CategoryConfig> = {
  ...
  pharmacy: {
    ...
    welcomeMessage: "Your pharmacy is ready to serve customers!",
    ...
    pageContent: {
      ...
      customersTitle: "Customer Records",
      customersDescription: "Track customer purchase history and prescriptions",
