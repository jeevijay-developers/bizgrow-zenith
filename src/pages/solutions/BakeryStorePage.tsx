          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="contents text-center sm:block sm:text-left">
              <div className="mb-4 sm:mb-6">
                <BizgrowTag icon={Cake}>Bakeries & Confectioneries</BizgrowTag>
              </div>
            ...
            <div
              className="order-10 relative mt-6 sm:order-none lg:mt-0"
            >
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4">
              Baked for <span className="text-gradient">Bakery Success</span>
            </h2>
