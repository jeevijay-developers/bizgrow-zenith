          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="contents text-center sm:block sm:text-left">
              <div className="mb-4 sm:mb-6">
                <BizgrowTag icon={Milk}>Dairy & Milk Delivery</BizgrowTag>
              </div>
              ...
              <div className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 bg-white rounded-lg sm:rounded-xl p-2.5 sm:p-4 shadow-xl hidden sm:block">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] sm:text-xs text-primary">2,500+ customers</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 sm:mb-10 md:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4">
              Built for <span className="text-gradient">Dairy Business</span>
            </h2>
