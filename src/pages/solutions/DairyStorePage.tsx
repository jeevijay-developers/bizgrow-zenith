      ...
      <section className="pt-20 sm:pt-24 md:pt-32 pb-12 sm:pb-16 md:pb-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <EyebrowTag icon={Milk} className="mb-4 sm:mb-6 border-ledger-paper/25 text-ledger-paper/85">
                Dairy & Milk Delivery
              </EyebrowTag>
              <H1 className="text-ledger-paper mb-4 sm:mb-6">
                Fresh Dairy,{" "}
                <span className="ledger-highlight">Smart Delivery</span>
              </H1>
              ...
              <div className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 bg-ledger-paper rounded-lg sm:rounded-xl p-2.5 sm:p-4 shadow-ledger hidden sm:block">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border border-ledger-rule bg-transparent flex items-center justify-center">
                    <Users className="w-4 h-4 sm:w-5 sm:h-5 text-ledger-sage" />
                  </div>
                  <div>
                    <p className="font-grotesk font-semibold text-ledger-ink text-xs sm:text-sm">Active Subscriptions</p>
                    <p className="text-[10px] sm:text-xs text-ledger-sage">2,500+ customers</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <H2 className="mb-4 sm:mb-6">
                Why Dairy Owners Love BizGrow 360
              </H2>
