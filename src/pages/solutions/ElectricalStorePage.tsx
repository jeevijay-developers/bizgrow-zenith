      ...
      <section className="pt-20 sm:pt-24 md:pt-32 pb-12 sm:pb-16 md:pb-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <EyebrowTag icon={Zap} className="mb-4 sm:mb-6 border-ledger-paper/25 text-ledger-paper/85">
                Electrical Supply Stores
              </EyebrowTag>
              <H1 className="text-ledger-paper mb-4 sm:mb-6">
                Digitize Your{" "}
                <span className="ledger-highlight">Electrical Store</span>
              </H1>
            ...
            <div className="relative mt-6 lg:mt-0">
              <div className="relative rounded-xl sm:rounded-2xl overflow-hidden shadow-ledger border border-ledger-paper/15 bg-ledger-paper/5 p-8 sm:p-12 flex items-center justify-center min-h-[200px] sm:min-h-[300px]">
                <div className="text-center">
                  <Lightbulb className="w-16 h-16 sm:w-24 sm:h-24 text-ledger-paper/60 mx-auto mb-4" />
                  <p className="text-ledger-paper/80 text-lg sm:text-xl font-grotesk font-semibold">Electrical Supplies Dashboard</p>
                  <p className="text-ledger-paper/50 text-sm mt-2 font-grotesk">Manage inventory, orders & deliveries</p>
                </div>
              </div>
              ...
              <div className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 bg-ledger-paper rounded-lg sm:rounded-xl p-2.5 sm:p-4 shadow-ledger hidden sm:block">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border border-ledger-rule bg-transparent flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] sm:text-xs text-ledger-sage">+28% this month</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <H2 className="mb-4 sm:mb-6">
                Why Electrical Store Owners Love BizGrow 360
              </H2>
