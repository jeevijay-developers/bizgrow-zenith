...
import { 
  ...
  Bell, Clock, BarChart3, Truck, MessageSquare, Tag, Users, Cable, Lightbulb
} from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-20 sm:pt-24 md:pt-32 pb-12 sm:pb-16 md:pb-24 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 right-10 w-48 sm:w-72 md:w-96 h-48 sm:h-72 md:h-96 bg-yellow-500/10 rounded-full blur-3xl" />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-yellow-500/20 text-yellow-400 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm font-medium mb-4 sm:mb-6">
            ...
            <div className="relative mt-6 lg:mt-0">
              <div className="relative rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl border border-white/10 bg-gradient-to-br from-yellow-500/20 to-amber-500/20 p-8 sm:p-12 flex items-center justify-center min-h-[200px] sm:min-h-[300px]">
                <div className="text-center">
                  <Lightbulb className="w-16 h-16 sm:w-24 sm:h-24 text-yellow-400 mx-auto mb-4" />
                  <p className="text-white/80 text-lg sm:text-xl font-semibold">Electrical Supplies Dashboard</p>
                  <p className="text-white/50 text-sm mt-2">Manage inventory, orders & deliveries</p>
                </div>
              </div>
              ...
              <div className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 bg-white rounded-lg sm:rounded-xl p-2.5 sm:p-4 shadow-xl hidden sm:block">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] sm:text-xs text-yellow-600">+28% this month</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 sm:mb-10 md:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4">
              Built for <span className="text-primary">Electrical Stores</span>
            </h2>
              ...
              <div className="space-y-3 sm:space-y-4">
                {benefits.map((benefit, index) => (
                  <div key={index} className="flex items-center gap-2.5 sm:gap-3">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-yellow-100 flex items-center justify-center flex-shrink-0">
                      <Check className="w-3 h-3 sm:w-4 sm:h-4 text-yellow-600" />
                    </div>
