      ...
      <section className="pt-20 sm:pt-24 md:pt-32 pb-12 sm:pb-16 md:pb-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <EyebrowTag icon={ShoppingBag} className="mb-4 sm:mb-6 border-ledger-paper/25 text-ledger-paper/85">
                Kirana & Grocery Stores
              </EyebrowTag>
              <H1 className="text-ledger-paper mb-4 sm:mb-6">
                Digitize Your{" "}
                <span className="ledger-highlight">Kirana Store</span>
              </H1>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] sm:text-xs text-ledger-sage">+32% this month</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <H2 className="mb-4 sm:mb-6">
                Why Kirana Owners Love BizGrow 360
              </H2>
