    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-20 sm:pt-24 md:pt-32 pb-12 sm:pb-16 md:pb-24 relative overflow-hidden bg-ledger-ink">
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <EyebrowTag icon={PenTool} className="mb-4 sm:mb-6 border-ledger-paper/25 text-ledger-paper/85">
                Stationery & Book Stores
              </EyebrowTag>
              <H1 className="text-ledger-paper mb-4 sm:mb-6">
                Digitize Your{" "}
                <span className="ledger-highlight">Stationery Store</span>
              </H1>
            ...
            <div className="relative mt-6 lg:mt-0">
              <div className="relative rounded-xl sm:rounded-2xl overflow-hidden shadow-ledger border border-ledger-paper/15 bg-ledger-paper/5 p-8 sm:p-12 flex items-center justify-center min-h-[200px] sm:min-h-[300px]">
                <div className="text-center">
                  <BookOpen className="w-16 h-16 sm:w-24 sm:h-24 text-ledger-paper/40 mx-auto mb-4" />
                  <p className="font-grotesk text-ledger-paper/80 text-lg sm:text-xl font-semibold">Stationery Dashboard</p>
                  <p className="font-grotesk text-ledger-paper/50 text-sm mt-2">Manage inventory, school orders & billing</p>
                </div>
              </div>
              ...
              <div className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 bg-ledger-paper rounded-lg sm:rounded-xl p-2.5 sm:p-4 shadow-ledger hidden sm:block">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] sm:text-xs text-ledger-sage">+22% this month</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 sm:mb-10 md:mb-12">
            <H2 className="mb-3 sm:mb-4">Built for Stationery Stores</H2>
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-ledger-paper">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <H2 className="mb-4 sm:mb-6">Why Stationery Store Owners Love BizGrow 360</H2>
